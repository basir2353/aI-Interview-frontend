            ...
            <div className="flex min-w-0 flex-1 flex-col gap-3 overflow-hidden rounded-xl border border-[var(--surface-light-border)] bg-[var(--surface-light-card)] p-3 shadow-sm">
              {codingTurnActive ? (
                <>
                  ...
                  {error && (
                    <p className="rounded-lg border border-[var(--error-border)] bg-[var(--error-bg)] px-3 py-2 text-xs text-[var(--error-text)]">{error || captureError}</p>
                  )}
                </>
              ) : codePanelRequested ? (
                <>
          ...
          <div className="absolute right-6 top-20 bottom-28 w-[560px] min-w-[520px] space-y-3">
            {codingTurnActive ? (
              <>
                ...
                {error && (
                  <p className="rounded-xl border border-[var(--error-border)] bg-[var(--error-bg)] px-4 py-3 text-sm text-[var(--error-text)]">{error || captureError}</p>
                )}
              </>
            ) : codePanelRequested ? (
              <>
